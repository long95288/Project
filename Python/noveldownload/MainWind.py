...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.progressBar.setGeometry(QtCore.QRect(60, 250, 321, 23))
        self.progressBar.setProperty("value", 0)
        self.progressBar.setObjectName("progressBar")
        self.label_2 = QtWidgets.QLabel(Form)
        self.label_2.setGeometry(QtCore.QRect(20, 250, 41, 21))
        font = QtGui.QFont()
        ...
        self.download_btn.setGeometry(QtCore.QRect(20, 210, 161, 31))
        ...
        self.continue_download_btn.setGeometry(QtCore.QRect(210, 210, 171, 31))
    ...
    def retranslateUi(self, Form):
        ...
        self.continue_download_btn.setText(_translate("Form", "继续下载"))
